...
namespace HospitalAdminApp.clinicDataSetTableAdapters {
...
SELECT doctorID, fname, lname, { fn CONCAT(fname, ' ', lname) } AS 'Full Name', dob, ssn, gender, phone, addressID FROM Doctor WHERE (doctorID = @doctorID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HospitalAdminApp.Properties.Settings.Default.clinicConnectionString;
        }
